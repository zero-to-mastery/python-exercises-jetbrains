...
class TestCase(unittest.TestCase):
    ...
    def test_duplicates(self):
        ...
        try:
            ...
            self.fail(msg="The variable duplicates seems to be undefined.")

        self.assertIsInstance(
            actual_value,
            list,
            msg="duplicates should be a list."
        )

        self.assertEqual(
            sorted(actual_value),
            sorted(expected_values),
            msg="duplicates should contain all duplicated values from some_list."
        )
